...
#include "../../../../src/file_player_mulran-master-bag/src/ROSThread.h"
...
void ROSThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ROSThread::StampShow)) {
                *result = 0;
            }
        }
        {
            typedef void (ROSThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ROSThread::StartSignal)) {
                *result = 1;
            }
        }
    }
